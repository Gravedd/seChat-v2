<template>
    ...
    <div class="menucontainer" v-show="showmenu">
        <div class="menuheader">
            <h2><router-link to="/">seChat</router-link></h2>
...
.menucontainer .router-link-active, .menulist .router-link-active {
